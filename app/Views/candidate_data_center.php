...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/candidate_data_center.css') ?>">
...
<body>
    ...
    <div class="container">
        ...
        <div class="tabs">
            ...
            <a href="<?= site_url('candidate_data_center') ?>" class="tab-link" data-tab="Candidate List">
                <button class="tab">Candidate List</button>
            </a>

            <!-- Button dengan Link Menu Favorites -->
            <a href="<?= site_url('candidate_detail') ?>" class="tab-link" data-tab="Candidate Detail">
        ...
        <div class="content">
            ...
            <div class="data-table">
                <div class="data-item">
                    ...
                    <label for="date-checkbox"></label>
                </div>
                <div class="data-item">Potential</div>
                <div class="data-item">Candidate Name</div>
                <div class="data-item">Job Expected Code</div>
                <div class="data-item">Job Expected Name</div>
                <div class="data-item">Apply Date</div>
                <div class="data-item">Current Status</div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        tabLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                if (tabName === 'Candidate List') {
                    // Pastikan transisi selesai sebelum berpindah
                    setTimeout(function() {
                        window.location.href =
                            'Candidate List'; // Mengalihkan ke halaman favorite.php
        ...
        showTabContent('Candidate List');
        setActiveTab('Candidate List');
    });
