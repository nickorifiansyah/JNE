...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/leave_absence.css') ?>">
...
<body>
    ...
    <div class="tabs-container">
        <div class="tabs">
            ...
            <a href="<?= site_url('leaveabsence') ?>" class="tab-link" data-tab="personaldata">
                <button class="tab">Leave Summary</button>
            </a>

            <!-- Button dengan Link Menu employee -->
            <a href="<?= site_url('LAIP') ?>" class="tab-link" data-tab="employee">
                <button class="tab">Leave Apply In Progress</button>
            </a>

            <!-- Button dengan Link Menu people -->
            <a href="<?= site_url('LH') ?>" class="tab-link" data-tab="people">
    ...
    <div class="leave-summary-container">
        ...
        <div class="summary-buttons">
            <button class="summary-button">Available</button>
            <button class="summary-button">Debt</button>
            <button class="summary-button">Entitlement</button>
            <button class="summary-button">Adjustment</button>
            <button class="summary-button">Previous Deduction</button>
            <button class="summary-button">Apply In Progress</button>
            <button class="summary-button">Realized</button>
            <button class="summary-button">Advance</button>
            <button class="summary-button">Paid</button>
            <button class="summary-button">Effective Date</button>
        </div>
    </div>
