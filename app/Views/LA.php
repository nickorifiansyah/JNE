...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/LA.css') ?>">
...
<body>
    ...
    <div class="tabs-container">
        <div class="tabs">
            ...
            <a href="<?= site_url('leave-absence') ?>" class="tab-link" data-tab="leave-absence">
            ...
            <a href="<?= site_url('absence_app') ?>" class="tab-link" data-tab="absence_app">
                <button class="tab active">Absence Application</button>
            </a>
    ...
    <div class="leave-container">
        <div class="button-container">
            <div class="apply-for">
                <p>Periode: 01/01/2024-31/12/2024 Status:</p>
            </div>
        </div>
    </div>

    <div class="filters-container">
        <button class="filter-btn">Adjustment for</button>
        <button class="filter-btn">Adjustment Date</button>
        <button class="filter-btn">Leave Priod</button>
        <button class="filter-btn">Effective Date</button>
        <button class="filter-btn">Adjustment</button>
        <button class="filter-btn">Description</button>
        <button class="filter-btn">Adjusment By</button>
    </div>
