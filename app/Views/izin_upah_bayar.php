...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/izin_upah_bayar.css') ?>">
...
<body>
    ...
    <div class="tabs-container">
        <div class="tabs">
            ...
            <a href="<?= site_url('LH') ?>" class="tab-link" data-tab="LH">
                <button class="tab active">Leave History</button>
            </a>

            <!-- Button dengan Link Menu compensation -->
            <a href="<?= site_url('LA') ?>" class="tab-link" data-tab="compensation">
    ...
    <div class="leave-container">
        <div class="button-container">
            <a href="<?= site_url('LH') ?>" class="btn">Annual Leave</a>
            <a href="<?= site_url('long_leave') ?>" class="btn">Long Leave</a>
            <a href="<?= site_url('izin_upah_bayar') ?>" class="btn active">Izin Upah Bayar</a>
        </div>
    </div>
    <div class="cancel-container">
        <button class="btn2"><i class='bx bxs-folder-minus'></i>Cancel Absence</button>
    </div>
