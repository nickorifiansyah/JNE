...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/long_leave.css') ?>">
...
<body>
    ...
    <div class="leave-container">
        <div class="button-container">
            ...
            <a href="<?= site_url('long_leave') ?>" class="btn active">Long Leave</a>
            <a href="<?= site_url('izin_upah_bayar') ?>" class="btn">Izin Upah Bayar</a>
        </div>
    </div>
