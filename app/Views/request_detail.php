...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/request_detail.css') ?>">
    ...
    <div class="container">
        ...
        <div class="layout-wrapper">
            <div class="subject">
                ...
                <div class="content">
                    <button>Organization Group</button>
                    <button>Organization</button>
                    <button>Job Level</button>
                    <button>Location</button>
                    <button>Company</button>
                    <button>Employment Type</button>
                    <button>Organization Recruit</button>
                </div>
            </div>
            <div class="element_job">
                <div class="header">Element Job Specification</div>
                <div class="content">
                    <!-- Konten spesifikasi pekerjaan akan ditempatkan di sini -->
                </div>
            </div>
        </div>
