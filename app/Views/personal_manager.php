...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/personal_manager.css') ?>">
...
<body>
    ...
    <div class="container">
        ...
        <div class="tabs">
            <button class="tab active">Personnel Change Notice</button>
            <button class="tab">Display Personnel Data Center</button>
            <button class="tab">Award Administration</button>
            <button class="tab">Violation Administration</button>
        </div>
        <div class="content">
            <ul>
                <li>Individual Changes</li>
                <li>Display Audit Trail</li>
                <li>User Login Log</li>
                <li>Database Log</li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="tabs">
            <button class="tab active">Employee Analysis Design</button>
            <button class="tab">Employee Analysis</button>
            <button class="tab">Detail Movement Analysis</button>
        </div>
        <div class="content">
            <ul>
                <li>Individual Changes</li>
