...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/Compensation.css') ?>">
...
<body>
    ...
    <div class="compensation-container">
        ...
        <div class="info-box">
            <div class="left">
                <p><strong>005 - BCA</strong></p>
                <p>Priority: 1</p>
                <p>Bank: 005 - BCA Account</p>
                <p>No: 5870208211</p>
                <p>Account Name: Dinah Aryani Zavitri</p>
                <p>Account Type: 02 - Cash</p>
                <p>Company Account: 0 - BCA</p>
            </div>
            <div class="right">
                <p>Use for THR: Yes</p>
                <p>Curr.: IDR</p>
