...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="<?= base_url('css/People_Development.css') ?>">
...
<body>
    ...
    <div class="people-development-container">
        <h2>Personal Document</h2>
        <div class="empty-section">
            <p>This Section is Empty</p>
        </div>
        <div class="buttons">
            <button class="btn">Period: 2023 - 2024</button>
        </div>
    </div>
    <div class="people-development-container">
        <h2>Vihicle</h2>
    ...
    <div class="job-history-container">
        ...
        <div>
            <div class="table">
                ...
                <div>Realize Start Date</div>
                <div>Realize End By</div>
                <div>Result</div>
            </div>
